        ...
        <div className="p-4 space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search drug name, brand, indication (e.g., ceftriaxone, augmentin, meningitis, asthma, status, croup)..."
              className="w-full pl-9.5 pr-8 py-2.5 bg-slate-50 hover:bg-white focus:bg-white border border-slate-300 focus:border-emerald-500 rounded-xl text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 shadow-2xs transition"
            />
            {searchTerm && (
              <button
                type="button"
                onClick={() => setSearchTerm('')}
                className="absolute right-2.5 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-slate-600 rounded-md transition"
              >
